...
class Application:
    def __init__(self, master=None):
        ...
        self.botao4 = Button(self.janela11, width=10, text="Voltar", command=self.voltarmenu)
        ...
        self.botao5 = Button(self.janela13, width=10, text="Gerar PDF", command=self.gerar_pdf)
    ...
    def gerar_pdf(self):
            ...
            headers = ["ID", "Nome", "Telefone", "E-mail", "Usuário", "Senha"]
            for i, header in enumerate(headers):
                c.drawString(x + i * 90, y, header)
            y -= 20
            ...
            for item in self.tree.get_children():
                ...
                for i, value in enumerate(values):
                    c.drawString(x + i * 90, y, str(value))
                y -= 20
